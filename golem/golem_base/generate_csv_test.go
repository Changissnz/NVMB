...
/*
no assertions, manual check 

file should have 10050 rows of data 
*/ 
func TestGenerateRandomCSVDataToFile(t *testing.T) {
...
/*
*/ 
func TestGenerateRandomRowDataExtended(t *testing.T) {
} 

/*
print-test 
*/ 
func TestGenerateRandomRowDataExtendedFlawInbut(t *testing.T) {
...
func TestGenerateRandomCSVDataToFileExtended(t *testing.T) {
	fp := "./datos/default2" 
