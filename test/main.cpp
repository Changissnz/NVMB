...
int main(int argc, char **argv) {
    ...
    //::testing::GTEST_FLAG(filter) = "NetworkDiscoveryProcessNode5*";
    //::testing::GTEST_FLAG(filter) = "NetworkNodeContractCFTest*";
    //::testing::GTEST_FLAG(filter) = "Network__CollectData_RandomNetwork_RunRandomNodeNatureVars*";
    //::testing::GTEST_FLAG(filter) = "Network__CollectData_RandomNetwork_RunRandomPatternStyleNodeNatureVars*";
    //::testing::GTEST_FLAG(filter) = "Network__RunTestGraph*";
    //::testing::GTEST_FLAG(filter) = "N1n0_RunDiscovery_ExecuteManualContractInput4_Check*";
